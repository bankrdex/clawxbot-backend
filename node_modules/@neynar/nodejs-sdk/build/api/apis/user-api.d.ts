...
export declare const UserApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    fetchVerifications: (fid: number | null, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const UserApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    fetchVerifications(fid: number | null, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FetchVerifications200Response>>;
    /**
     * Follow a user  (In order to follow a user `signer_uuid` must be approved)
     * @summary Follow user
     * @param {FollowReqBody} followReqBody
