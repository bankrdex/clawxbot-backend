...
export declare const FeedApiAxiosParamCreator: (configuration?: Configuration) => {
     ...
     *
     */
    fetchFeedByTopic: (slug: string, xNeynarExperimental?: boolean, withRecasts?: boolean | null, viewerFid?: number, limit?: number, cursor?: string, options?: RawAxiosRequestConfig) => Promise<RequestArgs>;
    /**
...
export declare const FeedApiFp: (configuration?: Configuration) => {
     ...
     *
     */
    fetchFeedByTopic(slug: string, xNeynarExperimental?: boolean, withRecasts?: boolean | null, viewerFid?: number, limit?: number, cursor?: string, options?: RawAxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<FeedResponse>>;
    /**
     * Fetch a personalized For You feed for a user
     * @summary For you
     * @param {number} fid FID of user whose feed you want to create
